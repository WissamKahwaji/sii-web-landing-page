...
const Timer = () => {
  ...
  return (
    <div className="text-center my-8  mx-4 md:mx-auto md:w-fit p-4 md:p-8 bg-transparent border border-primary text-primary  rounded-md shadow-md shadow-primary/30">
      <h2
        className="text-lg font-bold mb-4 md:mb-8 font-header text-secondary"
        style={{ direction: "rtl" }}
      >
